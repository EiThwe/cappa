...
const RoomsAndSuites = ({ dark }) => {
  const Rooms = [
    ...
    },
    {
      ...
      price: 300,
      time: "night",
      img: "https://duruthemes.com/demo/html/cappa/demo2-dark/img/rooms/4.jpg",
    },
    {
      id: 5,
      name: "Superior Room",
      price: 150,
      time: "night",
      img: "https://duruthemes.com/demo/html/cappa/demo2-dark/img/rooms/7.jpg",
    },
  ];
  ...
  return (
    <>
      <div className={dark ? "bg-bgDark" : "bg-bgSoft"}>
