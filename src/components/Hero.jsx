...
const Hero = () => {
  ...
  return (
    <div className="w-full min-h-screen  ">
      ...
      <div
        className="min-h-screen  absolute top-0 md:right-14 sm:right-10 right-2 z-10 sm:flex hidden flex-col justify-center 
      items-center gap-3"
      >
      ...
      <div
        className="min-h-screen  absolute top-0 md:left-14 sm:left-10 left-2 z-10 sm:flex hidden flex-col sm:justify-center
