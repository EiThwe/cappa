...
const SimilarRoom = () => {
    const Rooms = [
        ...
        { id: 4, name: "Deluxe Room", price: 300, time: "night" ,"img" : "https://duruthemes.com/demo/html/cappa/demo2-dark/img/rooms/6.jpg"},
        { id: 5, name: "Superior Room", price: 150, time: "night","img" : "https://duruthemes.com/demo/html/cappa/demo2-dark/img/rooms/8.jpg" },
        { id: 6, name: "Wellness Room", price: 400, time: "night","img" : "https://duruthemes.com/demo/html/cappa/demo2-dark/img/rooms/5.jpg" },
      ];
      const responsive = {
        0: {
            items: 1,
