        ...
        <div className=" coming-soon-bg   ">
          ...
          <div className="  text-center py-16 ">
            ...
            <div className="calanderDiv w-full lg:w-[70%] text-white mx-auto gap-5  flex  flex-wrap md:flex-row md:flex-nowrap justify-center mb-16  ">
              <div className="Day  border-[0.5px] border-secondary border-opacity-30 text-white w-44 h-44 sm:w-72 md:w-44 py-10 text-center">
              ...
              <div className="Hour  border-[0.5px] border-secondary border-opacity-30  text-white w-44 h-44 py-10 sm:w-72 md:w-44 text-center">
                <h2 className="text-[40px] font-gilda   ">
                  {timeRemaining?.hours}{" "}
                </h2>
                <p className="text-[20px] font-barlowCondensed uppercase text-center">
              ...
              <div className="Minutes  border-[0.5px] border-secondary border-opacity-30  text-white w-44 h-44 py-10 sm:w-72 md:w-44 text-center">
                <h2 className="text-[40px] font-gilda   ">
              ...
              <div className="Second  border-[0.5px] border-secondary border-opacity-30  text-white w-44 h-44 py-10 sm:w-72 md:w-44 text-center">
                <h2 className="text-[40px] font-gilda   ">
